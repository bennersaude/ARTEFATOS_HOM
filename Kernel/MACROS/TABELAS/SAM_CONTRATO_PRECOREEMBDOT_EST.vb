'HASH: EC8B7E2D9829C8EAF13E99DBD80087D8
'Macro: SAM_CONTRATO_PRECOREEMBDOT_EST
'#Uses "*bsShowMessage"
'#Uses "*ProcuraEvento"
...
Public Sub BOTAOREPLICARPORCBOS_OnClick()
  ...
  SessionVar("TabelaDeDotacao") = "SAM_CONTRATO_PRECOREEMBDOT_EST"
  ...
  RefreshNodesWithTable("SAM_CONTRATO_PRECOREEMBDOT_EST")
End Sub
...
Public Function VerificarEventoNaVigencia As String
	...
	sEstado = CurrentQuery.FieldByName("ESTADO").Value
  ...
  sCondicao = sCondicao + " AND ESTADO =  	" + sEstado

	sLinha = Interface.Vigencia(CurrentSystem, "SAM_CONTRATO_PRECOREEMBDOT_EST", _
