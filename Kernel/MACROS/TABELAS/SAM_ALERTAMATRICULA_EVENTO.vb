'HASH: 38BAD970CF4F9C09115D7BC031FFB0CE
...
Public Sub TABLE_BeforePost(CanContinue As Boolean)
  ...
  Q.Clear
  Q.Add("SELECT * FROM SAM_ALERTAMATRICULA_EVENTO")
  ...
  End If
  Q.Add("   AND (ALERTAMATRICULA = :ALERTAMATRICULA)")
  ...
  Q.ParamByName("ALERTAMATRICULA").Value = CurrentQuery.FieldByName("ALERTAMATRICULA").AsInteger
  Q.Active = True
