'HASH: A7146EB30921F32B2016107736F6BA81
'Macro: SAM_PCTNEGGERAL_GRAU
'#Uses "*bsShowMessage"
...
Public Sub TABLE_BeforeInsert(CanContinue As Boolean)
  ...
  Dim SQL
  Set SQL = NewQuery
  SQL.Add("SELECT DATAFINAL FROM SAM_PCTNEGGERAL  WHERE HANDLE = :HPCTNEGGERAL")
  SQL.ParamByName("HPCTNEGGERAL").Value = RecordHandleOfTable("SAM_PCTNEGGERAL")
  SQL.Active = True
  ...
  CurrentQuery.Cancel
  RefreshNodesWithTable("SAM_PCTNEGGERAL_GRAU")
End If
