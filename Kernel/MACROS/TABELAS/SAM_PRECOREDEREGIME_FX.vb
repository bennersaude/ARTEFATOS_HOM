'HASH: 974E3425CD24DB5A61A7808281457AD4
'Macro: SAM_PRECOREDEREGIME_FX
...
Public Sub TABLE_BeforePost(CanContinue As Boolean)
	...
	Linha = Interface.EventoFx(CurrentSystem, "SAM_PRECOREDEREGIME_FX", CurrentQuery.FieldByName("DATAINICIAL").AsDateTime, CurrentQuery.FieldByName("DATAFINAL").AsDateTime, EstruturaI, EstruturaF, Condicao)
...
Public Sub BOTAOVALORES_OnClick()
	...
	If Not CurrentQuery.FieldByName("TABELAPRECO").IsNull Then
		...
		If CurrentQuery.FieldByName("REDERESTRITAPRESTADOR").IsNull Then
			...
			If Nivel <> -1 Then
				Interface.ValoresFxEventos(CurrentSystem, 60, CurrentQuery.FieldByName("REDERESTRITA").Value, -1, CurrentQuery.FieldByName("ESTRUTURAINICIAL").Value, CurrentQuery.FieldByName("ESTRUTURAFINAL").Value, CurrentQuery.FieldByName("REGIMEATENDIMENTO").Value, CurrentQuery.FieldByName("CONVENIO").AsInteger, CurrentQuery.FieldByName("HANDLE").AsInteger, CurrentQuery.FieldByName("MASCARATGE").AsInteger)
			Else
		...
		Else
			...
			If Nivel <> -1 Then
				Interface.ValoresFxEventos(CurrentSystem, 70, CurrentQuery.FieldByName("REDERESTRITA").Value, CurrentQuery.FieldByName("REDERESTRITAPRESTADOR").Value, CurrentQuery.FieldByName("ESTRUTURAINICIAL").Value, CurrentQuery.FieldByName("ESTRUTURAFINAL").Value, CurrentQuery.FieldByName("REGIMEATENDIMENTO").Value, CurrentQuery.FieldByName("CONVENIO").AsInteger, CurrentQuery.FieldByName("HANDLE").AsInteger, CurrentQuery.FieldByName("MASCARATGE").AsInteger)
			Else
