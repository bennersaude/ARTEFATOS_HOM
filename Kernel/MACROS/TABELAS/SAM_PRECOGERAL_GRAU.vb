'HASH: 802E91AC86E2DB3A644C2EB2D7ED18FD
'MACRO SAM_PRECOGERAL_GRAU
'#Uses "*ProcuraEvento"
'#Uses "*ProcuraGrau"
...
Public Sub TABLE_BeforePost(CanContinue As Boolean)
	...
	Linha = INTERFACE.Vigencia(CurrentSystem, "SAM_PRECOGERAL_GRAU", "DATAINICIAL", "DATAFINAL", CurrentQuery.FieldByName("DATAINICIAL").AsDateTime, CurrentQuery.FieldByName("DATAFINAL").AsDateTime, "GRAU", Condicao)
