'HASH: 49EDBE75769BDF1BAFCAA8F09E9A17B1
'Macro: SAM_TGE_COMPLEMENTAR_MUNICIPIO
...
Public Sub TABLE_BeforePost(CanContinue As Boolean)
  ...
  Set SQL = NewQuery
  SQL.Add("SELECT COUNT(*) T FROM SAM_TGE_COMPLEMENTAR_MUNICIPIO WHERE EVENTOAGERAR = :EVENTOAGERAR And GRAUAGERAR = :GRAUAGERAR")
