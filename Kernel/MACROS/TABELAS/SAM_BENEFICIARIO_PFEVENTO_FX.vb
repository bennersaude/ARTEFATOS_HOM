'HASH: 116F6951678BAD6DF9F3E8F36A162115
' MACRO : SAM_BENEFICIARIO_PFEVENTO_FX
'#Uses "*bsShowMessage"
...
Public Sub TABLE_AfterInsert()
  ...
  qOrdem.Active = False
  qOrdem.Clear
  qOrdem.Add("SELECT MAX(ORDEM) ORDEM FROM SAM_BENEFICIARIO_PFEVENTO_FX WHERE BENEFICIARIOTABPFEVENTO = :pHANDLEPFEVENTO")
  qOrdem.ParamByName("pHANDLEPFEVENTO").AsInteger = CurrentQuery.FieldByName("BENEFICIARIOTABPFEVENTO").AsInteger
  qOrdem.Active = True
...
Public Sub TABLE_AfterScroll()
  ...
  qTipoPF.Clear
  qTipoPF.Add("SELECT TIPOPFVARIAVEL FROM SAM_BENEFICIARIO_PFEVENTO WHERE HANDLE = :pPFEVENTO")
  qTipoPF.ParamByName("pPFEVENTO").AsInteger = RecordHandleOfTable("SAM_BENEFICIARIO_PFEVENTO")
  qTipoPF.Active = True
  ...
  qPreNatal.Clear
  qPreNatal.Add("SELECT CONTROLEPORPRENATAL FROM SAM_BENEFICIARIO_PFEVENTO WHERE HANDLE = :pPFEVENTO")
  qPreNatal.ParamByName("pPFEVENTO").AsInteger = RecordHandleOfTable("SAM_BENEFICIARIO_PFEVENTO")
...
Public Sub TABLE_BeforeDelete(CanContinue As Boolean)
  ...
  Q2.Add("  FROM SAM_BENEFICIARIO_PFEVENTO_FX                       ")
  Q2.Add(" WHERE BENEFICIARIOTABPFEVENTO = :BENEFICIARIOTABPFEVENTO ")
  Q2.Add("   AND ORDEM >  :ORDEM                                    ")
  Q2.ParamByName("BENEFICIARIOTABPFEVENTO").AsInteger = CurrentQuery.FieldByName("BENEFICIARIOTABPFEVENTO").AsInteger
...
Public Sub TABLE_BeforePost(CanContinue As Boolean)
  ...
  qBuscaOrdem.Clear
  qBuscaOrdem.Add("SELECT HANDLE FROM SAM_BENEFICIARIO_PFEVENTO_FX WHERE ORDEM = :pORDEM AND BENEFICIARIOTABPFEVENTO = :pPFEVENTO")
  ...
  qBuscaOrdem.ParamByName("pPFEVENTO").AsInteger = CurrentQuery.FieldByName("BENEFICIARIOTABPFEVENTO").AsInteger
  If (CurrentQuery.FieldByName("HANDLE").AsInteger > 0) Then
  ...
  qAux.Active = False
  qAux.Clear
  qAux.Add("SELECT HANDLE FROM SAM_BENEFICIARIO_PFEVENTO_FX WHERE TABVALORPF <> :TABVALORPF AND BENEFICIARIOTABPFEVENTO = :BENEFICIARIOTABPFEVENTO")
  qAux.ParamByName("TABVALORPF").AsInteger = CurrentQuery.FieldByName("TABVALORPF").AsInteger
  qAux.ParamByName("BENEFICIARIOTABPFEVENTO").AsInteger = CurrentQuery.FieldByName("BENEFICIARIOTABPFEVENTO").AsInteger
  qAux.Active = True
