'HASH: 0FAA0BE44E80E583C1D82D4B14443280

'CLI_ROTALTERARECURSOAGENDA
...
Public Sub BOTAOCONFIRMAR_OnClick()
  ...
  Else
    ...
    'Se encontrou,foi alterado então deve trocar o recurso
    If Not SQL.FieldByName("USUARIOALTEROU").IsNull Then
      DADOS.Clear
      DADOS.Add("SELECT R.RECURSOSUBSTITUTO, E.ESPECIALIDADE, A.DATAMARCADA, A.HORAMARCADA")
      DADOS.Add("  FROM CLI_ROTALTERARECURSO R, CLI_ROTALTERARECURSOAGENDA RA, CLI_ESCALA E, CLI_AGENDA A")
      DADOS.Add(" WHERE R.ESCALASUBSTITUTO = E.HANDLE")
      DADOS.Add("   AND RA.ROTALTERARECURSO = R.HANDLE")
      DADOS.Add("   AND RA.PACIENTE = A.HANDLE")
      ...
      BSCLI001DLL.ConfirmaAgenda(CurrentSystem, _
                                 ...
                                 (DADOS.FieldByName("DATAMARCADA").AsDateTime + DADOS.FieldByName("HORAMARCADA").AsDateTime -2), _
                                 "N")
      Set BSCLI001DLL = Nothing
    End If

    If InTransaction Then Commit
    RefreshNodesWithTable("CLI_ROTALTERARECURSOAGENDA")
  End If
  ...
  Else
    ...
    If Not SQL.FieldByName("USUARIOALTEROU").IsNull Then
      ...
      BSCLI001DLL.DesmarcaAgenda(CurrentSystem, _
                                 CurrentQuery.FieldByName("PACIENTE").AsInteger, _
                                 DADOS.FieldByName("RECURSOSUBSTITUTO").AsInteger, _
                                 (DADOS.FieldByName("DATAMARCADA").AsDateTime + DADOS.FieldByName("HORAMARCADA").AsDateTime -2))
      Set BSCLI001DLL = Nothing
    End If
