'HASH: 56050BC64B738BAC7C050E6C80BFAFE1
'Macro: SAM_PRECOMUNICIPIO_ACOMODACAO
'#Uses "*ProcuraGrau"
'#Uses "*bsShowMessage"
...
Public Sub TABLE_BeforePost(CanContinue As Boolean)
	...
	Linha = Interface.Vigencia(CurrentSystem, "SAM_PRECOMUNICIPIO_ACOMODACAO", "DATAINICIAL", "DATAFINAL", CurrentQuery.FieldByName("DATAINICIAL").AsDateTime, CurrentQuery.FieldByName("DATAFINAL").AsDateTime, "MUNICIPIO", Condicao)
