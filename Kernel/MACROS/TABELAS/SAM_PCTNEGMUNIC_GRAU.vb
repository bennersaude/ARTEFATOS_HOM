'HASH: 7C79894B35CAFAE90747FC4CE11F191E
'Macro: SAM_PCTNEGMUNIC_GRAU
...
Public Sub TABLE_BeforeDelete(CanContinue As Boolean)
  ...
  Dim SQL
  Set SQL = NewQuery
  SQL.Add("SELECT DATAFINAL FROM SAM_PCTNEGMUNIC  WHERE HANDLE = :HPCTNEGMUNIC")
  SQL.ParamByName("HPCTNEGMUNIC").Value = RecordHandleOfTable("SAM_PCTNEGMUNIC")
  SQL.Active = True
  ...
  CurrentQuery.Cancel
  CanContinue = False
  RefreshNodesWithTable("SAM_PCTNEGMUNIC_GRAU")
End If
End Sub
