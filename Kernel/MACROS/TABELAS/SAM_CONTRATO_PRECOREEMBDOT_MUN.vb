'HASH: B2DD1123F7C5AF72AB3F0E0D47E52F66
'Macro: SAM_CONTRATO_PRECOREEMBDOT_MUN
'#Uses "*bsShowMessage"
'#Uses "*ProcuraEvento"
...
Public Sub BOTAOREPLICARPORCBOS_OnClick()
  ...
  SessionVar("TabelaDeDotacao") = "SAM_CONTRATO_PRECOREEMBDOT_MUN"
  ...
  RefreshNodesWithTable("SAM_CONTRATO_PRECOREEMBDOT_MUN")
End Sub
...
Public Function VerificarEventoNaVigencia As String
	...
	sMunicipio = CurrentQuery.FieldByName("MUNICIPIO").Value
	...
	sCondicao = sCondicao + " AND MUNICIPIO = " + sMunicipio

	sLinha = Interface.Vigencia(CurrentSystem, "SAM_CONTRATO_PRECOREEMBDOT_MUN", _
