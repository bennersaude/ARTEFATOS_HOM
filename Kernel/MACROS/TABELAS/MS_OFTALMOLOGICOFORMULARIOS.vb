'HASH: CB4CA54E66CE4DE277577D65F7DE6028
...
'Set Sql =NewQuery
'  Sql.Clear
'  Sql.Add("SELECT 1 FROM MS_OFTALMOLOGICOPACPESQRESP WHERE HANDLE = :HANDLE")
...
'  Sql.Clear
'  Sql.Add("DELETE FROM MS_OFTALMOLOGICOPACIENTEPESQ WHERE FORMULARIO = :HANDLE")
'  Sql.ParamByName("HANDLE").AsInteger =CurrentQuery.FieldByName("HANDLE").AsInteger
'  Sql.ExecSQL
