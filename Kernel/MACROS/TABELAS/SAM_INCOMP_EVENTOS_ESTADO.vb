'HASH: A70BF2F2520FA8E553929D49D97B42FB
'Macro: SAM_INCOMP_EVENTOS_ESTADO
'Alteração - Soares - SMS: 60815 - 23/05/2006
'#Uses "*bsShowMessage"
...
Public Sub TABLE_AfterScroll()
  ...
  'EVENTO ANTERIOR
  SQL.Clear
  SQL.Add("SELECT	T.ESTRUTURA,T.DESCRICAO ")
  ...
  If Not SQL.EOF Then
    EVENTOANTERIOR.Text = SQL.FieldByName("ESTRUTURA").AsString + " - " + SQL.FieldByName("DESCRICAO").AsString
  Else
    EVENTOANTERIOR.Text = ""
  End If
  ...
  If Not SQL.EOF Then
    EVENTOPOSTERIOR.Text = SQL.FieldByName("ESTRUTURA").AsString + " - " + SQL.FieldByName("DESCRICAO").AsString
  Else
    EVENTOPOSTERIOR.Text = ""
  End If
