'HASH: A7248ECF36D22D5A92684067510C9724
'Macro: SAM_PRECOESTADOREGIME_DOTAC
'#Uses "*ProcuraEvento"
'#Uses "*bsShowMessage"
...
Public Sub BOTAOREPLICARPORCBOS_OnClick()
  ...
  SessionVar("TabelaDeDotacao") = "SAM_PRECOESTADOREGIME_DOTAC"
...
Public Sub TABLE_BeforePost(CanContinue As Boolean)
	...
	Linha = Interface.Vigencia(CurrentSystem, "SAM_PRECOESTADOREGIME_DOTAC", "DATAINICIAL", "DATAFINAL", CurrentQuery.FieldByName("DATAINICIAL").AsDateTime, CurrentQuery.FieldByName("DATAFINAL").AsDateTime, "ESTADO", Condicao)
