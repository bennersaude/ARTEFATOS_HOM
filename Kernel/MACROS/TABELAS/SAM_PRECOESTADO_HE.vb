'HASH: A43C4EA707AA452BA51276A05CF11AB6
'#Uses "*bsShowMessage"
...
Public Sub TABLE_BeforePost(CanContinue As Boolean)
	...
	Linha = Interface.Vigencia(CurrentSystem, "SAM_PRECOESTADO_HE", "DATAINICIAL", "DATAFINAL", CurrentQuery.FieldByName("DATAINICIAL").AsDateTime, CurrentQuery.FieldByName("DATAFINAL").AsDateTime, "ESTADO", CONDICAO)
