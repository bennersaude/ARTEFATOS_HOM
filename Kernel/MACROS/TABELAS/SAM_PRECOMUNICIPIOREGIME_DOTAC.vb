'HASH: A93EA89C3F002FBA0401D177672425F0
'Macro: SAM_PRECOMUNICIPIOREGIME_DOTAC
'#Uses "*ProcuraEvento"
'#Uses "*bsShowMessage"
...
Public Sub BOTAOREPLICARPORCBOS_OnClick()
  ...
  SessionVar("TabelaDeDotacao") = "SAM_PRECOMUNICIPIOREGIME_DOTAC"
...
Public Sub TABLE_BeforePost(CanContinue As Boolean)
	...
	Linha = Interface.Vigencia(CurrentSystem, "SAM_PRECOMUNICIPIOREGIME_DOTAC", "DATAINICIAL", "DATAFINAL", CurrentQuery.FieldByName("DATAINICIAL").AsDateTime, CurrentQuery.FieldByName("DATAFINAL").AsDateTime, "MUNICIPIO", Condicao)
