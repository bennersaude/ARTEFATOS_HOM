'HASH: E628C2C1290CBDABC9A8F9D874CB4945
'MACRO SAM_PRECOESTADO_GRAU
'#Uses "*ProcuraEvento"
'#Uses "*ProcuraGrau"
...
Public Sub TABLE_BeforePost(CanContinue As Boolean)
	...
	Linha = INTERFACE.Vigencia(CurrentSystem, "SAM_PRECOESTADO_GRAU", "DATAINICIAL", "DATAFINAL", CurrentQuery.FieldByName("DATAINICIAL").AsDateTime, CurrentQuery.FieldByName("DATAFINAL").AsDateTime, "ESTADO", Condicao)
