'HASH: 17EC24657506DD30FBC68D563E8D5C59
'Macro: SAM_ALERTAPLANO_EVENTO
Option Explicit
...
Public Sub TABLE_BeforePost(CanContinue As Boolean)
  ...
  Q.Clear
  Q.Add("SELECT * FROM SAM_ALERTAPLANO_EVENTO")
  ...
  End If
  Q.Add("   AND (PLANOALERTA = :PLANOALERTA)")
  ...
  Q.ParamByName("PLANOALERTA").Value = CurrentQuery.FieldByName("PLANOALERTA").AsInteger
  Q.Active = True
