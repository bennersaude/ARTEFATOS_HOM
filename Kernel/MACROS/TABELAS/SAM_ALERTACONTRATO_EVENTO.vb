'HASH: CAD689FF354A0B36E15A5FC45D6F737A
'Macro: SAM_ALERTACONTRATO_EVENTO
'#Uses "*bsShowMessage"
Option Explicit
...
Public Sub TABLE_BeforePost(CanContinue As Boolean)
  ...
  Q.Clear
  Set Q = NewQuery
  Q.Add("SELECT * FROM SAM_ALERTACONTRATO_EVENTO")
  ...
  End If
  Q.Add("   AND (CONTRATOALERTA = :CONTRATOALERTA)")
