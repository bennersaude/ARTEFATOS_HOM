'HASH: B188C01CB9FA6EA16F02DD9FE8B66BBB
'Macro: SAM_PRECOMUNICIPIOREGIME_FX
'#Uses "*ProcuraEvento"
'#Uses "*bsShowMessage"
...
Public Sub TABLE_BeforePost(CanContinue As Boolean)
	...
	' Checar Vigencia
	Condicao = " MUNICIPIO = " + CurrentQuery.FieldByName("MUNICIPIO").AsString
	...
	Linha = Interface.EventoFx(CurrentSystem, "SAM_PRECOMUNICIPIOREGIME_FX", CurrentQuery.FieldByName("DATAINICIAL").AsDateTime, CurrentQuery.FieldByName("DATAFINAL").AsDateTime, EstruturaI, EstruturaF, Condicao)
...
Public Sub BOTAOVALORES_OnClick()
	...
	If Nivel <> -1 Then
		If Not CurrentQuery.FieldByName("TABELAPRECO").IsNull Then
			...
			Interface.ValoresFxEventos(CurrentSystem, 30, CurrentQuery.FieldByName("MUNICIPIO").Value, -1, CurrentQuery.FieldByName("ESTRUTURAINICIAL").Value, CurrentQuery.FieldByName("ESTRUTURAFINAL").Value, CurrentQuery.FieldByName("REGIMEATENDIMENTO").Value, CurrentQuery.FieldByName("CONVENIO").AsInteger, CurrentQuery.FieldByName("HANDLE").AsInteger, CurrentQuery.FieldByName("MASCARATGE").AsInteger)
		Else
			bsShowMessage("Para visualizar os preços dos eventos desta configuração de faixa, a tabela genérica deve ser informada !", "I")
		End If
	Else
		bsShowMessage("Na configuração de busca de preço, não foi definido um nível para o Município !", "I")
	End If
End Sub
