'HASH: F3828C3A9A4173409D9EFFA65A870EC6
'Macro: SAM_PCTNEGESTADO_GRAU
...
Public Sub TABLE_BeforeDelete(CanContinue As Boolean)
  Dim SQL
  Set SQL = NewQuery
  SQL.Add("SELECT DATAFINAL FROM SAM_PCTNEGESTADO  WHERE HANDLE = :HPCTNEGESTADO")
  SQL.ParamByName("HPCTNEGESTADO").Value = RecordHandleOfTable("SAM_PCTNEGESTADO")
  SQL.Active = True
  ...
  CurrentQuery.Cancel
  CanContinue = False
  RefreshNodesWithTable("SAM_PCTNEGESTADO_GRAU")
End If
