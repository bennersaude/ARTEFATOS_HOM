'HASH: 0ECBB85F8DF25058AF70A3C3AA6A96A3
 'Macro: SAM_PRECOFILIAL_TPSERVICO
'#Uses "*bsShowMessage"
...
Public Sub TABLE_BeforePost(CanContinue As Boolean)
	...
	Linha = Interface.Vigencia(CurrentSystem, "SAM_PRECOFILIAL_TPSERVICO", "DATAINICIAL", "DATAFINAL", CurrentQuery.FieldByName("DATAINICIAL").AsDateTime, CurrentQuery.FieldByName("DATAFINAL").AsDateTime, "FILIAL", Condicao)
