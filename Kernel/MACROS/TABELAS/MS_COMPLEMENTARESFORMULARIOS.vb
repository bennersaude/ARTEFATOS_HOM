'HASH: 04E3DF2F137A475C1836440BA14B548F
...
'Set Sql =NewQuery
'  Sql.Clear
'  Sql.Add("SELECT 1 FROM MS_COMPLEMENTARESPACPESQRESP WHERE HANDLE = :HANDLE")
...
'  Sql.Clear
'  Sql.Add("DELETE FROM MS_COMPLEMENTARESPACIENTEPESQ WHERE FORMULARIO = :HANDLE")
'  Sql.ParamByName("HANDLE").AsInteger =CurrentQuery.FieldByName("HANDLE").AsInteger
'  Sql.ExecSQL
