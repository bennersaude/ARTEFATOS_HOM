'HASH: 8732B002B73BC765DDCB9194ECE657DE
'Macro: SAM_PRECOESTADO_FX
'#Uses "*bsShowMessage"
'#Uses "*ProcuraEvento"
...
Public Sub TABLE_BeforePost(CanContinue As Boolean)
	...
	If CanContinue = True Then
		...
		Linha = Interface.EventoFx(CurrentSystem, "SAM_PRECOESTADO_FX", CurrentQuery.FieldByName("DATAINICIAL").AsDateTime, CurrentQuery.FieldByName("DATAFINAL").AsDateTime, EstruturaI, EstruturaF, Condicao)
...
Public Sub BOTAOVALORES_OnClick()
	...
	If Nivel <> -1 Then
		If Not CurrentQuery.FieldByName("TABELAPRECO").IsNull Then
			...
			Interface.ValoresFxEventos(CurrentSystem, 20, CurrentQuery.FieldByName("ESTADO").Value, -1, CurrentQuery.FieldByName("ESTRUTURAINICIAL").Value, CurrentQuery.FieldByName("ESTRUTURAFINAL").Value, -1, CurrentQuery.FieldByName("CONVENIO").AsInteger, CurrentQuery.FieldByName("HANDLE").AsInteger, CurrentQuery.FieldByName("MASCARATGE").AsInteger)
		Else
