'HASH: 1C50F3D6F74459C63C2C37D7305CBE25
'Macro: SAM_PRECOMUNICIPIO_FX
'#Uses "*ProcuraEvento"
'#Uses "*bsShowMessage"
...
Public Sub TABLE_BeforePost(CanContinue As Boolean)
	...
	If CanContinue = True Then
		...
		Linha = Interface.EventoFx(CurrentSystem, "SAM_PRECOMUNICIPIO_FX", CurrentQuery.FieldByName("DATAINICIAL").AsDateTime, CurrentQuery.FieldByName("DATAFINAL").AsDateTime, EstruturaI, EstruturaF, Condicao)
...
Public Sub BOTAOVALORES_OnClick()
	...
	If Nivel <> -1 Then
		If Not CurrentQuery.FieldByName("TABELAPRECO").IsNull Then
			...
			Interface.ValoresFxEventos(CurrentSystem, 30, CurrentQuery.FieldByName("MUNICIPIO").Value, -1, CurrentQuery.FieldByName("ESTRUTURAINICIAL").Value, CurrentQuery.FieldByName("ESTRUTURAFINAL").Value, -1, CurrentQuery.FieldByName("CONVENIO").AsInteger, CurrentQuery.FieldByName("HANDLE").AsInteger, CurrentQuery.FieldByName("MASCARATGE").AsInteger)
		Else
