'HASH: 55D55A1919E36851510C0FF32EE3F73A
'MACRO SAM_PRECOFILIAL_GRAU
'#Uses "*ProcuraEvento"
'#Uses "*ProcuraGrau"
...
Public Sub TABLE_BeforePost(CanContinue As Boolean)
	...
	Linha = INTERFACE.Vigencia(CurrentSystem, "SAM_PRECOFILIAL_GRAU", "DATAINICIAL", "DATAFINAL", CurrentQuery.FieldByName("DATAINICIAL").AsDateTime, CurrentQuery.FieldByName("DATAFINAL").AsDateTime, "FILIAL", Condicao)
