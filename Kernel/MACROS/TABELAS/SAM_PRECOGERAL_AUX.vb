'HASH: 406074E97C3063D4CEF2B3CACC700804
'Macro: SAM_PRECOGERAL_AUX
'#Uses "*bsShowMessage"
...
Public Sub TABLE_BeforePost(CanContinue As Boolean)
	...
	Linha = Interface.Vigencia(CurrentSystem, "SAM_PRECOGERAL_AUX", "DATAINICIAL", "DATAFINAL", CurrentQuery.FieldByName("DATAINICIAL").AsDateTime, CurrentQuery.FieldByName("DATAFINAL").AsDateTime, "NUMAUXILIAR", Condicao)
