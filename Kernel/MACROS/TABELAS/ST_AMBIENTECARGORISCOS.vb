'HASH: EDE976BDCA865130FDC5CFE89F6F51C6
'MACRO: ST_AMBIENTECARGORISCOS

Public Sub ATIVAR_OnClick()
  'Set obj = CreateBennerObject("ST.Ativar")
  'obj.Ambiente(CurrentSystem)RecordHandleOfTable("ST_AMBIENTECARGORISCOS")
  'obj.Codigo(CurrentSystem)3
