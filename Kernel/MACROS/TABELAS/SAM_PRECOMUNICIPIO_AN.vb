'HASH: 799D1DBB7967FBF2CDFE3D216DDBA053
'Macro: SAM_PRECOMUNICIPIO_AN
...
Public Sub BOTAOVALORPORTE_OnClick()
	...
	q.Add("SELECT NIVEL6 FROM SAM_CONFIGURABUSCAPRECO")

	q.Active = True

	If q.FieldByName("NIVEL6").IsNull Then
		result = "Na configuração de busca de preço, não foi definido um nível para Município!"
	...
	INTERFACE.ValorPorteAnestesico(CurrentSystem, 6, CurrentQuery.FieldByName("HANDLE").AsInteger, vValor, vValorAuxiliar)
...
Public Sub TABLE_BeforePost(CanContinue As Boolean)
	...
	Linha = INTERFACE.Vigencia(CurrentSystem, "SAM_PRECOMUNICIPIO_AN", "DATAINICIAL", "DATAFINAL", CurrentQuery.FieldByName("DATAINICIAL").AsDateTime, CurrentQuery.FieldByName("DATAFINAL").AsDateTime, "MUNICIPIO", Condicao)
