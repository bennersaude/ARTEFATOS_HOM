'HASH: CB905267A383457C3DBE038D9766AF6B
'Macro: SAM_PRECOESTADO_DOTAC
'#Uses "*bsShowMessage"
'#Uses "*ProcuraEvento"
  ...
  Dim Interface As Object
	...
	If Nivel <> -1 Then
		...
		Else
			...
			ValorEvento = Interface.ValorEvento(CurrentSystem, vDataBaseChecagemVigencia, 99, -1, -1, -1, -1, -1, CurrentQuery.FieldByName("ESTADO").Value, -1, -1, CurrentQuery.FieldByName("EVENTO").Value, -1, Nivel, CurrentQuery.FieldByName("CONVENIO").AsInteger, "", CurrentQuery.FieldByName("CBOS").AsString)
...
Public Sub BOTAOREPLICARPORCBOS_OnClick()
  ...
  SessionVar("TabelaDeDotacao") = "SAM_PRECOESTADO_DOTAC"
...
Public Sub TABLE_BeforePost(CanContinue As Boolean)
	...
	Linha = Interface.Vigencia(CurrentSystem, "SAM_PRECOESTADO_DOTAC", "DATAINICIAL", "DATAFINAL", CurrentQuery.FieldByName("DATAINICIAL").AsDateTime, CurrentQuery.FieldByName("DATAFINAL").AsDateTime, "ESTADO", Condicao)
