'HASH: 4EB48476BDB7F7ABD121A72D50390FF4
'Macro: SAM_CONTRATO_PRECOREEMBDOT_REG
'#Uses "*bsShowMessage"
'#Uses "*ProcuraEvento"
...
Public Sub BOTAOREPLICARPORCBOS_OnClick()
  ...
  RefreshNodesWithTable("SAM_CONTRATO_PRECOREEMBDOT_REG")
End Sub
...
Public Function VerificarEventoNaVigencia As String
	...
	sRegAtend = CurrentQuery.FieldByName("REGIMEATENDIMENTO").Value
	...
	sCondicao = sCondicao + " AND REGIMEATENDIMENTO = " + sRegAtend


	sLinha = Interface.Vigencia(CurrentSystem, "SAM_CONTRATO_PRECOREEMBDOT_REG", _
...
Public Sub ArmazenarSecao
  SessionVar("TabelaDeDotacao") = "SAM_CONTRATO_PRECOREEMBDOT_REG"
